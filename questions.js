var questions = [
    ["Conjunto","A. Idealismo","B. Meticulosidade", "C. Diversão", "D. Persistência"],
    [" Conjunto","A. Inovação", "B. Organização", "C. Integração", "D.Execução" ],
    [" Conjunto","A. Liberdade", "B. Controle", "C. Compreensão", "D. Paciência"],
    [" Conjunto","A. Escolha", "B. Melhoria", "C. Lazer", "D. Autonomia"],
    [" Conjunto","A. Criatividade", "B. Pontualidade", "C. Parceria", "D.Foco"],
    [" Conjunto","A. Adaptação", "B. Consistência", "C. Equipe", "D. Líder"],
    ["Conjunto", "A. Mudança", "B. Rotina", "C. Amizade", "D. Produtividade"],
];
